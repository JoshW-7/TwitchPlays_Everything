...
# Init Vjoy #
joyState = [JoystickState(), JoystickState()]
Shutdown()
Initialize()

joyState[0].XAxis = AXIS_NIL
joyState[0].YAxis = AXIS_NIL
joyState[0].ZAxis = AXIS_NIL
joyState[0].Buttons = 0x00000000
SetPOV(joyState[0], 0, POV_NIL)
SetPOV(joyState[0], 1, POV_NIL)
SetPOV(joyState[0], 2, POV_NIL)
SetPOV(joyState[0], 3, POV_NIL)
joyState[1].XAxis = AXIS_NIL
joyState[1].YAxis = AXIS_NIL
joyState[1].ZAxis = AXIS_NIL
joyState[1].Buttons = 0x00000000
SetPOV(joyState[1], 0, POV_NIL)
SetPOV(joyState[1], 1, POV_NIL)
SetPOV(joyState[1], 2, POV_NIL)
SetPOV(joyState[1], 3, POV_NIL)
